            ...
            <div class="p-5 bg-light rounded contact-form">
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <h1 class="display-5 mb-0">We’re Here to Help You</h1>
                    </div>
                    <div class="col-md-6 col-lg-7">
                        <p class="mb-4">
                            Have any questions, feedback, or need assistance? Fill out the form below and we’ll get back to
                            you as soon as possible.
                            You can also reach us via phone or email for urgent queries.
                        </p>
                        <form>
