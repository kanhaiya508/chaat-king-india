...
<body onload="window.print()">
    ...
    <table>
        ...
        @if ($due <= 0 && $paid > 0)
            <tr>
                <td colspan="2" class="center bold" style="color: #28a745;">PAID IN FULL</td>
            </tr>
        @elseif($due <= 0 && $paid == 0 && $order->is_paid)
            <tr>
                <td colspan="2" class="center bold" style="color: #28a745;">MARKED PAID (NO AMOUNT)</td>
            </tr>
        @endif
    </table>
    ...
    <div class="center">
        <div class="bold" style="color: #28a745;">ORDER COMPLETED</div>
        <div class="mt-4">Thank you! Visit Again.</div>
